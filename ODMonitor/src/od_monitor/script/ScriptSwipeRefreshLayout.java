 ...
 * *********************************************************************************
 */
public class ScriptSwipeRefreshLayout extends ViewGroup {
     ...
     * @param context
     */
    public ScriptSwipeRefreshLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public ScriptSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
